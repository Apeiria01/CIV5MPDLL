...
protected:
	...
	static int lAddFeudalVassalage(lua_State* L)
	{
		return BasicLuaMethod(L, &CvDeal::AddFeudalVassalage);
	}
	...
	static int lRemoveFeudalVassalage(lua_State* L)
	{
		return BasicLuaMethod(L, &CvDeal::RemoveFeudalVassalage);
	}
