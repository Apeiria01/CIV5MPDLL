...
public:
	...
	int GetCityStateTradeRouteYieldModifierGlobal(YieldTypes eIndex) const;
	void ChangeCityStateTradeRouteYieldModifierGlobal(YieldTypes eIndex, int iChange);
...
protected:
	...
	std::vector<int> m_aiCityStateTradeRouteYieldModifierGlobal;
